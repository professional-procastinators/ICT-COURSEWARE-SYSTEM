        ...
        var cardString = `
                <div class="col-sm-4">
                    <div class="card animated zoomIn">
                        <img class="card-img-top" src="${inputLessonItems[i].imageSource}" alt="Card image cap">
                        <h4 class="card-header fontsforweb_fontid_9785">${inputLessonItems[i].name}</h4>
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary" data-toggle="modal" id="${inputLessonItems[i].name}" data-target="#${i}">Show Lesson</a>
                            </div>
                    </div>
                </div>`;
